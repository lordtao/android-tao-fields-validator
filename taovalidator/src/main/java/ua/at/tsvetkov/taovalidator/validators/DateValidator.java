package ua.at.tsvetkov.taovalidator.validators;
...
public class DateValidator extends AbstractValidator {
    ...
    private static final int YEAR = 364 * 24 * 60 * 60 * 1000; // TODO
    ...
    public DateValidator(EditText editText, int years, String dateFormat, String errMsg) {
        ...
        mStartDate = new Date(System.currentTimeMillis() - (YEAR * years));
        mFinishDate = null;
        sdf = new SimpleDateFormat(dateFormat, Locale.ENGLISH);
    }
